...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/60 px-4 py-10 shadow-soft md:px-8">
      ...
      <div className="relative grid items-center gap-8 md:grid-cols-2">
        ...
        <motion.div
          ...
          className="relative flex justify-center md:-mt-6"
        >
          <div className="absolute -inset-6 rounded-[28px] bg-gradient-to-br from-primary/20 via-primary/5 to-accent/10 blur-3xl" />
          <div className="relative aspect-square max-w-[210px] rounded-full bg-gradient-to-b from-background to-muted/60 shadow-[0_12px_40px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_70px_rgba(0,0,0,0.45)]">
